products_data1 = [ {
    ...
    localStorage.setItem("masai-ecomm1",JSON.stringify(products_data1))
    
    let cartLSdata= JSON.parse(localStorage.getItem("masai-cart")) || []
     let products1 = document.querySelector(".products1")
      
     var Filter=document.querySelector("#sort1").value
    
     function  display(data1){
      products1.innerHTML=null;
      ...
      data1.forEach(function(el,){
        ...
        card.append(img,title,desc,price,cato,button)
        products1.append(card)
           
      })
     }
    
    display(products_data1)  
    console.log(products_data1)
     ...
     Filter.addEventListener("change",function(){
      if(Filter== "Lowest price" ){
        ...
        var filtered = products_data1.sort(function(a,b){
    ...
    // window.location.href="abhay.html"
     }